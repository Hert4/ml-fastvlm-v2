    ...
    if 'llava' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            if 'mpt' in model_name.lower():
                ...
                # Determine if using Qwen3 based on model_base or config
                if _is_qwen3_model(model_base) or getattr(cfg_pretrained, 'model_type', '').startswith('llava_qwen3'):
            ...
            if 'mpt' in model_name.lower():
                ...
                # Determine if using Qwen3 based on model_path or config
                if _is_qwen3_model(model_path) or _is_qwen3_model(model_name):
                    from llava.model.language_model.llava_qwen import LlavaQwen3ForCausalLM
                    if LlavaQwen3ForCausalLM is None:
                        raise ImportError("Qwen3 support requires transformers>=4.51.0")
